...
MCA student and aspiring **Full-Stack / Backend Developer** focused on building reliable, scalable, and user-friendly applications.

I enjoy solving real-world problems using modern web technologies, especially:
- **Spring Boot & Java backend development**
- **React and modern frontend ecosystems**
- **Cloud-ready application architecture**

🎯 **Currently open to internship opportunities** where I can contribute to real products and grow with experienced teams.

## 🚀 What I Bring
- Strong foundation in backend APIs, authentication, and data modeling
- Hands-on full-stack project development mindset
- Curiosity-driven learner with consistent execution and collaboration focus
...
### 🤝 Let's Connect
If you’re hiring interns or collaborating on impactful projects, I’d be glad to connect.
